...
void gamestory1::run() {
	...
	cout << "■ 어린시절 부모님은 알수 없는 이유로 어디론가 사라졌다.                                              ■" << endl;
	cout << "■ 마을 사람들의 이야기로는 부모님이 산책을 하러 마을 밖을 나간후 행방을 알수 없다고 했다.            ■" << endl;
	cout << "■ 부모님은 사라지셨지만, 마을사람들이 나를 거둬주었기에 지금까지 잘 살 수 있었다.                    ■" << endl;
	cout << "■ 어느날 농작물을 재배하던 도중 하늘이 매우 검은 구름으로 가득 매워지는것을 보았다.                  ■" << endl;
	cout << "■ 그리고 동시에 아주 세찬비가 내렸고, 마을 사람들은 홍수를 대비해 준비를 할려고 하였다.              ■" << endl;
	cout << "■ 갑자기!!! 매우 강력한 큰 붉은 번개가 내 집을 내리쳤다. 동시에 내 집은 검은색 사원처럼 변하였다.    ■" << endl;
	cout << "■ 나는 옆에 있던 삽으로 있는 힘껏 내집의 벽을 내리쳤지만, 튕겨져 나갔고, 벽은 매우 단단하게 느껴졌다.■" << endl;
	...
	cout << "■ 마을 사람들은 이 상황에 대해 회의를 개최할려 하였고, 나는 튕겨져 나간 삽을 주을려고 하였다.        ■" << endl;
	cout << "■ 갑자기 문이 아주 큰 바람소리를 내며 덜컹 열리더니 나를 날려보냈다.                                 ■" << endl;
	cout << "■ 다행히 다치진 않았고, 팔에 약간의 상처를 입었다.                                                   ■" << endl;
	cout << "■ 문이 열렸음에도 사원의 안은 너무나도 어두워 안에 무엇이 있는지 확인할 수 없었다.                   ■" << endl;
	...
	cout << "■ 나는 누나도 형도 동생도 없다.                                                                      ■" << endl;
	cout << "■ 즉 나는 잃을게 없다. 또한 이 검게 변해버린 나의 집이 마치 날 매우 강하게 끌어당기는 것 같았다.     ■" << endl;
	cout << "■ 또한 이집은 내 집이기 때문에 마을 사람들에게 내가 집 안에 들어가겠다 하였다.                       ■" << endl;
	cout << "■ 마을 사람들은 위험해 보인다며 반대하였지만, 눈빛은 원하는 것처럼 느껴졌다.                         ■" << endl;
